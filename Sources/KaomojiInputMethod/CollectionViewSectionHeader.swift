...
protocol CollectionViewSectionHeader: NSView {
  var titleTextField: NSTextField! { get }
}

class LegacyCollectionViewSectionHeader: NSVisualEffectView, NSCollectionViewElement, CollectionViewSectionHeader {
...
class TahoeCollectionViewSectionHeader: NSView, NSCollectionViewElement, CollectionViewSectionHeader {
  private(set) var stackView: NSStackView!
  private(set) var titleTextField: NSTextField!
  private(set) var stackViewTopAnchor: NSLayoutConstraint!
  private(set) var stackViewBottomAnchor: NSLayoutConstraint!
...
struct CollectionViewSectionHeader_Previews: PreviewProvider {
  static var previews: some View {
    NSViewPreview {
      let header = TahoeCollectionViewSectionHeader()
